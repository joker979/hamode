...
const youtube = new YouTube("AIzaSyBDooO_JdlDSggtkWDyL2r61p4qMjpFOgs"); //تعديل اساسي سوي اي بي اي جديد
const hastebins = require("hastebin-gen");
const getYoutubeID = require("get-youtube-id");
const yt_api_key = "AIzaSyBDooO_JdlDSggtkWDyL2r61p4qMjpFOgs"; ///تعديل اساسي سوي اي بي اي جديد
...
client.on("message", pixelbot => {
  // itzZa1D - Codes Team.
  if (pixelbot.content.startsWith(prefix + "معلوماتي الشخصية")) {
    // itzZa1D - Codes Team.
...
////كود معلومات البوت
client.on("message", message => {
  if (message.content === prefix + "معلومات البوت") {
...
////كود معلومات السيرفر
client.on("message", message => {
  if (message.content.startsWith(prefix + "معلومات السيرفر")) {
    if (!message.channel.guild)
...
\`${prefix}معلومات البوت\` : لعرض معلومات عن البوت 
\`${prefix}معلوماتي الشخصية\` : لعرض معلومات عنك 
